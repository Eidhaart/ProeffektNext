  ...
  return (
    <div className="privacy-policy">
      ...
      <p>
        ...
        <a href="https://www.proeffekt.se">proeffekt.se</a> website
      ...
      <p>
        ...
        Proeffekt AB (&#8220;Proeffekt AB&#8221;, &#8220;we&#8221;,
        &#8220;us&#8221; or &#8220;our&#8221;). If you are entering into this
        Policy on behalf of a business or other legal entity, you represent that
        you have the authority to bind such entity to this Policy, in which case
        the terms &#8220;User&#8221;, &#8220;you&#8221; or &#8220;your&#8221;
        shall refer to such entity. If you do not have such authority, or if you
        do not agree with the terms of this Policy, you must not accept this
        Policy and may not access and use the Website and Services. By accessing
      ...
      <p>
        ...
        it is absolutely necessary to maintain the Website and Services.
      ...
      <p>
        ...
        the performance of this Policy with you and/or for any pre-contractual
      ...
      <p>
        ...
        (collectively, &#8220;Service Providers&#8221;) we rely upon to assist
        in the operation of the Website and Services available to you and whose
      ...
      <p>
        ...
        necessary to comply with our legal obligations, to enforce our Policy,
        resolve disputes, and unless a longer retention period is required or
        permitted by law.
      </p>
      <p>
      ...
      <p>
        ...
        law. When we do, we will post a notice on the Website, send you an
        email.
      </p>
      ...
      <p>
        <a href="https://proeffekt.se">https://proeffekt.se</a>
        <br></br>
        <a>proeffektab@gmail.com</a>
        <br></br>
        <a>+46 70-557 76 20</a>
      </p>
      <p>
      ...
      <p>This document was last updated on February 21, 2024</p>
      <br></br>
      <br></br>
      <br></br>
      <br></br>
